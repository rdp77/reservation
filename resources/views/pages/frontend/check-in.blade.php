...
<form method="POST" action="{{ route('users.store') }}">
    @csrf
    <h2 class="section-title">{{ __('Kode') }}</h2>
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control datepicker @error('tgl') is-invalid @enderror" name="tgl" required
                            autofocus>
                    </div>
                    @error('tgl')
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input class="form-control @error('time') is-invalid @enderror" type="time" name="session" required>
                    @error('session')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
